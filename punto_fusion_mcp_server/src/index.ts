 ...
 *
 * This server provides tools to interact with Punto Fusión,
 * enabling WhatsApp chatbots (via n8n) to manage:
 * - Contacts (WhatsApp verification)
 * - Students (enrollment, profile management)
 * - Bookings (class scheduling, rescheduling)
 * - Payments (invoices, billing)
 * - Services (available classes)
 */
